...
process = _,_<:((_<:*(1-g)+(_<: par(i,3,comblp(ba.take(i+1,tsa1),ba.take(i+1,gsa1),g)) :> seq(i,2,apfmoor(rt60, g)))/4) ,(_<:*(1-g)+(_<: par(i,3,comblp(ba.take(i+1,tsa2),ba.take(i+1,gsa2),g)) :> seq(i,2,apfmoor(rt60, g)))/4) ) ;